...
var Calendar = /*#__PURE__*/function (_PureComponent) {
  ...
  function Calendar(_props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "focusToDate", function (date) {
      ...
      var targetMonthIndex = (0, _date.differenceInCalendarMonths)(date, props.minDate, _this.dateOptions);
    ...
    _defineProperty(_assertThisInitialized(_this), "changeShownDate", function (value) {
      ...
      var modeMapper = {
        monthOffset: function monthOffset() {
          return (0, _date.addMonths)(focusedDate, value);
        },
        setMonth: function setMonth() {
          return (0, _date.setMonth)(focusedDate, value);
        },
        setYear: function setYear() {
          return (0, _date.setYear)(focusedDate, value);
        },
        set: function set() {
          return value;
        }
      };
      var newDate = (0, _date.min)([(0, _date.max)([modeMapper[mode](), minDate]), maxDate]);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleScroll", function () {
      ...
      var visibleMonth = (0, _date.addMonths)(minDate, visibleMonths[0] || 0);
      var isFocusedToDifferent = !(0, _date.isSameMonth)(visibleMonth, focusedDate);
    ...
    _defineProperty(_assertThisInitialized(_this), "onDragSelectionEnd", function (date) {
      ...
      if (displayMode !== 'dateRange' || (0, _date.isSameDay)(newRange.startDate, date)) {
        _this.setState({
          drag: {
            status: false,
            range: {}
    ...
    _defineProperty(_assertThisInitialized(_this), "estimateMonthSize", function (index, cache) {
      ...
      var monthStep = (0, _date.addMonths)(minDate, index);
      ...
      var isLongMonth = (0, _date.differenceInDays)(end, start, _this.dateOptions) + 1 > 7 * 5;
  ...
  _createClass(Calendar, [{
    ...
    value: function renderWeekdays() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        start: (0, _date.startOfWeek)(now, this.dateOptions),
        end: (0, _date.endOfWeek)(now, this.dateOptions)
      }).map(function (day, i) {
        return /*#__PURE__*/_react["default"].createElement("span", {
          className: _this4.styles.weekDay,
          key: i
        }, (0, _date.format)(day, _this4.props.weekdayDisplayFormat, _this4.dateOptions));
      }));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        length: (0, _date.differenceInCalendarMonths)((0, _date.endOfMonth)(maxDate), (0, _date.addDays)((0, _date.startOfMonth)(minDate), -1), this.dateOptions),
        treshold: 500,
        type: "variable",
        ...
        var monthStep = (0, _date.addMonths)(_this5.state.focusedDate, i);
        return /*#__PURE__*/_react["default"].createElement(_Month["default"], _extends({}, _this5.props, {
          onPreviewChange: onPreviewChange || _this5.updatePreview,
          preview: preview || _this5.state.preview,
          ranges: ranges,
...
Calendar.defaultProps = {
  ...
  direction: 'vertical',
  maxDate: (0, _date.addYears)(new Date(), 20),
  minDate: (0, _date.addYears)(new Date(), -100),
