...
var DayCell = /*#__PURE__*/function (_Component) {
  ...
  function DayCell(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderPreviewPlaceholder", function () {
      ...
      var startDate = preview.startDate ? (0, _date.endOfDay)(preview.startDate) : null;
      var endDate = preview.endDate ? (0, _date.startOfDay)(preview.endDate) : null;
      var isInRange = (!startDate || (0, _date.isAfter)(day, startDate)) && (!endDate || (0, _date.isBefore)(day, endDate));
      var isStartEdge = !isInRange && (0, _date.isSameDay)(day, startDate);
      var isEndEdge = !isInRange && (0, _date.isSameDay)(day, endDate);
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSelectionPlaceholders", function () {
      ...
      if (_this.props.displayMode === 'date') {
        var isSelected = (0, _date.isSameDay)(_this.props.day, _this.props.date);
      ...
      var inRanges = ranges.reduce(function (result, range) {
        ...
        if (startDate && endDate && (0, _date.isBefore)(endDate, startDate)) {
          var _ref = [endDate, startDate];
          startDate = _ref[0];
          endDate = _ref[1];
        }

        startDate = startDate ? (0, _date.endOfDay)(startDate) : null;
        endDate = endDate ? (0, _date.startOfDay)(endDate) : null;
        var isInRange = (!startDate || (0, _date.isAfter)(day, startDate)) && (!endDate || (0, _date.isBefore)(day, endDate));
        var isStartEdge = !isInRange && (0, _date.isSameDay)(day, startDate);
        var isEndEdge = !isInRange && (0, _date.isSameDay)(day, endDate);
  ...
  _createClass(DayCell, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react["default"].createElement("span", null, (0, _date.format)(this.props.day, this.props.dayDisplayFormat))));
    }
  }]);
