  ...
  function DateRange(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "calcNewSelection", function (value) {
      ...
      if (!isSingleValue) {
        ...
        // startDate selection
        var dayOffset = (0, _date.differenceInCalendarDays)(endDate, startDate);
        startDate = value;
        endDate = moveRangeOnFirstSelection ? (0, _date.addDays)(value, dayOffset) : value;
        if (maxDate) endDate = (0, _date.min)([endDate, maxDate]);
      ...
      var inValidDatesWithinRange = disabledDates.filter(function (disabledDate) {
        return (0, _date.isWithinInterval)(disabledDate, {
          start: startDate,
          end: endDate
        });
      });
      ...
      if (inValidDatesWithinRange.length > 0) {
        if (isStartDateSelected) {
          startDate = (0, _date.addDays)((0, _date.max)(inValidDatesWithinRange), 1);
        } else {
          endDate = (0, _date.addDays)((0, _date.min)(inValidDatesWithinRange), -1);
        }
      }
