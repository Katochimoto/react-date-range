...
function renderWeekdays(styles, dateOptions, weekdayDisplayFormat) {
  ...
  }, (0, _date.eachDayOfInterval)({
    start: (0, _date.startOfWeek)(now, dateOptions),
    end: (0, _date.endOfWeek)(now, dateOptions)
  }).map(function (day, i) {
    return /*#__PURE__*/_react["default"].createElement("span", {
      className: styles.weekDay,
      key: i
    }, (0, _date.format)(day, weekdayDisplayFormat, dateOptions));
  }));
}
...
var Month = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Month, [{
    ...
    value: function render() {
      ...
      var minDate = this.props.minDate && (0, _date.startOfDay)(this.props.minDate);
      var maxDate = this.props.maxDate && (0, _date.endOfDay)(this.props.maxDate);
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, (0, _date.format)(this.props.month, this.props.monthDisplayFormat, this.props.dateOptions)) : null, this.props.showWeekDays && renderWeekdays(styles, this.props.dateOptions, this.props.weekdayDisplayFormat), /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var isStartOfMonth = (0, _date.isSameDay)(day, monthDisplay.startDateOfMonth);
        var isEndOfMonth = (0, _date.isSameDay)(day, monthDisplay.endDateOfMonth);
        var isOutsideMinMax = minDate && (0, _date.isBefore)(day, minDate) || maxDate && (0, _date.isAfter)(day, maxDate);
        var isDisabledSpecifically = disabledDates.some(function (disabledDate) {
          return (0, _date.isSameDay)(disabledDate, day);
        });
        return /*#__PURE__*/_react["default"].createElement(_DayCell["default"], _extends({}, _this.props, {
          ...
          isWeekend: (0, _date.isWeekend)(day, _this.props.dateOptions),
          isToday: (0, _date.isSameDay)(day, now),
          isStartOfWeek: (0, _date.isSameDay)(day, (0, _date.startOfWeek)(day, _this.props.dateOptions)),
          isEndOfWeek: (0, _date.isSameDay)(day, (0, _date.endOfWeek)(day, _this.props.dateOptions)),
          isStartOfMonth: isStartOfMonth,
          isEndOfMonth: isEndOfMonth,
          key: index,
          disabled: isOutsideMinMax || isDisabledSpecifically,
          isPassive: !(0, _date.isWithinInterval)(day, {
